            ...
            if (e.getSource() == ve.btnQuitar) {
                if ("Permanente".equals(varU.getStatus())) {
                    ...
                    try {
                        ModConexion objCon = new ModConexion();
                        Connection con = objCon.getConexion();
                        ps = con.prepareStatement("UPDATE usuarios SET matricula = ?, status = ? WHERE matricula = '" + ve.txtMatricula.getText() + "'");
                        ...
                        var.setCorreo(ve.email.getText() + "@gmail.com");
                        varU.setAsunto("ACCESO DENEGADO.");
                        varU.setMensaje("Se le informa que su cuenta con el nombre de usuario: " + ve.txtNombre.getText() + " " + ve.txtApPat.getText() + " " + ve.txtApMat.getText() + " y con la "
                                + "matrícula: " + ve.txtMatricula.getText() + " se le ha negado el acceso, por lo cual, usted no podrá acceder a su sesión.\n"
                                + "Para mayor información, contacte al administrador a travez de poo.acompanamiento@gmail.com, o también "
                                + "podría acudir a la oficina correspondiente.");
            ...
            if (e.getSource() == ve.btnDar) {
                if ("Permanente".equals(varU.getStatus())) {
                    ...
                    try {
                        ...
                        var.setCorreo(ve.email.getText() + "@gmail.com");
                        varU.setAsunto("ACCESO AUROTIZADO.");
                        varU.setMensaje("Se le informa que su cuenta con el nombre de usuario: " + ve.txtNombre.getText() + " " + ve.txtApPat.getText() + " " + ve.txtApMat.getText() + " y con la "
                                + "matrícula: " + ve.txtMatricula.getText() + " se le ha autorizado el acceso, por lo cual, a partir de ahora, "
                                + "usted podra acceder a su sesión.");
