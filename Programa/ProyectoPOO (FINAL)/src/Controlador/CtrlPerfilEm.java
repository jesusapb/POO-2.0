...
import Vista.Empleado.VstPerfilEmp;
            ...
            if ("Permanente".equals(var.getStatus())) {
                ...
                if (e.getSource() == vp.btncambioTab) {
                    if (vp.btncambioTab.getText().equals("Tabla de calificaciones")) {
                        vp.btnVer.setVisible(false);
                        vp.anuncio.setText("Calificaciones:");//Registro de Quizzes presentados:
                        vp.btncambioTab.setText("Tabla de registro de Quizzes");//Tabla de calificaciones
